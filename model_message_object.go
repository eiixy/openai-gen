...
type MessageObject struct {
	...
	Attachments []MessageObjectAttachmentsInner `json:"attachments"`
...
// If the value is explicit nil, the zero value for []MessageObjectAttachmentsInner will be returned
