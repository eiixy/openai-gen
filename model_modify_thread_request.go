...
type ModifyThreadRequest struct {
	ToolResources NullableThreadObjectToolResources `json:"tool_resources,omitempty"`
...
func (o *ModifyThreadRequest) GetToolResources() ThreadObjectToolResources {
	if o == nil || IsNil(o.ToolResources.Get()) {
		var ret ThreadObjectToolResources
		return ret
	}
...
// SetToolResources gets a reference to the given NullableThreadObjectToolResources and assigns it to the ToolResources field.
