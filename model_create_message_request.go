...
type CreateMessageRequest struct {
	...
	Attachments []MessageObjectAttachmentsInner `json:"attachments,omitempty"`
...
func (o *CreateMessageRequest) GetContent() CreateMessageRequestContent {
	if o == nil {
		var ret CreateMessageRequestContent
		return ret
	}
...
func (o *CreateMessageRequest) GetAttachments() []MessageObjectAttachmentsInner {
	if o == nil {
		var ret []MessageObjectAttachmentsInner
		return ret
	}
...
// SetAttachments gets a reference to the given []MessageObjectAttachmentsInner and assigns it to the Attachments field.
