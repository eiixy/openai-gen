...
type ThreadObject struct {
	...
	ToolResources NullableThreadObjectToolResources `json:"tool_resources"`
...
// If the value is explicit nil, the zero value for ThreadObjectToolResources will be returned
